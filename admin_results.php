      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;" style="font-family: Roboto Slab; font-size: 26px">Results</a>
          </div>
		...
		<div class="row">
          <div class="card col-lg-6">
            <div class="card-header card-header-primary">
				 ...
				 <p class="card-category">Students Enroll for this Companies Tests</p>
		  ...
		  <div class="card col-lg-6">
            <div class="card-header card-header-primary">
              <h4 class="card-title">Test Lists</h4>
              <p class="card-category">Student list cleared the Test (Test wise Listing)</p>
            </div>
            <div class="card-body">
